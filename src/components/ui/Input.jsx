    ...
    <div className={`w-full flex flex-col gap-1.5 ${className}`}>
      ...
      <div className="relative flex items-center">
        ...
        <input
          ...
          className={`
            w-full px-4 py-2.5 rounded-xl bg-slate-900 border text-slate-100 text-sm 
        ...
        {isPasswordType && (
          <button
            ...
            className="absolute right-3.5 text-slate-400 hover:text-slate-200 transition-colors focus:outline-none cursor-pointer"
            tabIndex="-1"
          >
            {showPassword ? (
